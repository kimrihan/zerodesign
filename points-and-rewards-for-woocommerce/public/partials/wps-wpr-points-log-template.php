...
<div class="wps_wpr_slide_toggle">
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
                <th class="wps-wpr-view-log-Date">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Date', 'points-and-rewards-for-woocommerce' ); ?></span>
                </th>
                <th class="wps-wpr-view-log-Status">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Point Status', 'points-and-rewards-for-woocommerce' ); ?></span>
                </th>
            </tr>
        </thead>
        <tr>
            ...
            <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
                <?php esc_html_e( '회원가입 이벤트', 'points-and-rewards-for-woocommerce' ); ?><a class="wps_wpr_open_toggle"
                    href="javascript:;"></a></p>
            <td>
                <?php
            ...
            <td>
                <?php
								echo '+' . esc_html( $point_log['registration']['0']['registration'] ).'원';
								?>
            </td>
            <?php
						}
        ...
        <tr>
            ...
            <td><?php echo esc_html( wps_wpr_set_the_wordpress_date_format( $point_log['import_points']['0']['date'] ) ); ?>
            </td>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        ...
        <?php esc_html_e( '주문 취소, 환불 시 사용된 포인트 재 적립 ', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    ...
    <table class="wps_wpr_common_table">
        ...
        <tr>
            ...
            <td><?php echo '+' . esc_html( $value['refund_points_applied_on_cart'] ); ?>원
            </td>
        </tr>
        <?php
			}
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Coupon Creation', 'points-and-rewards-for-woocommerce' ); ?><a class="wps_wpr_open_toggle"
            href="javascript:;"></a></p>
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points Earned via Particular Product', 'points-and-rewards-for-woocommerce' ); ?> <a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( '상품 구매에 대한 10% 포인트 적립 ', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
        ...
        <tr>
            <td><?php echo esc_html( wps_wpr_set_the_wordpress_date_format( $value['date'] ) ); ?></td>
            <td><?php echo '+' . esc_html( $value['pro_conversion_points'] ); ?>원</td>
        </tr>
        <?php
					}
					?>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points Log Table With Points Earned Each time on Order Total', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Deducted Points earned on Order Total on Order Refund', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Deducted Points earned on Order Total on Order Cancellation', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points earned via giving review/comment', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    <a class="wps_wpr_open_toggle" href="javascript:;"></a>
    <table class="wps_wpr_common_table">
        <thead>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Membership Points', 'points-and-rewards-for-woocommerce' ); ?><a class="wps_wpr_open_toggle"
            href="javascript:;"></a></p>
    <a class="wps_wpr_open_toggle" href="javascript:;"></a>
    <table class="wps_wpr_common_table">
        <thead>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Deduction of points as you have purchased your product through points', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Deduction of points for your return request', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points returned successfully on your return request', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( '환불에 따른 상품 구매 포인트 회수', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    ...
    <table class="wps_wpr_common_table">
        ...
        <tr>
            <td><?php echo esc_html( wps_wpr_set_the_wordpress_date_format( $value['date'] ) ); ?></td>
            <td><?php echo '-' . esc_html( $value['deduction_currency_spent'] ); ?>원</td>
        </tr>
        <?php
					}
					?>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( '사용한 포인트', 'points-and-rewards-for-woocommerce' ); ?><a class="wps_wpr_open_toggle"
            href="javascript:;"></a></p>
    ...
    <table class="wps_wpr_common_table">
        ...
        <tr>
            <td><?php echo esc_html( wps_wpr_set_the_wordpress_date_format( $value['date'] ) ); ?></td>
            <td><?php echo '-' . esc_html( $value['cart_subtotal_point'] ); ?>원</td>
        </tr>
        <?php
					}
					?>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Oops!! Points are expired!', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Order Points Deducted due to Cancelation of Order', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Assigned Points Deducted due Cancelation of Order', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points Returned due to Cancelation of Order', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points deducted for purchasing the product', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points deducted successfully as you have shared your points', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
        ...
        <thead>
            <tr>
                ...
                <th class="wps-wpr-view-log-Activity">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Shared to', 'points-and-rewards-for-woocommerce' ); ?></span>
                </th>
            </tr>
        </thead>
        <?php
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points received successfully as someone has shared', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    ...
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
                ...
                <th class="wps-wpr-view-log-Activity">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Received Points via ', 'points-and-rewards-for-woocommerce' ); ?></span>
                </th>
            </tr>
        </thead>
        <?php
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Updated By Admin', 'points-and-rewards-for-woocommerce' ); ?><a class="wps_wpr_open_toggle"
            href="javascript:;"></a></p>
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
                ...
                <th class="wps-wpr-view-log-Activity">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Reason', 'points-and-rewards-for-woocommerce' ); ?></span>
                </th>
            </tr>
        </thead>
        <?php
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points Deduct to the wallet', 'points-and-rewards-for-woocommerce' ); ?>
        <a class="wps_wpr_open_toggle" href="javascript:;"></a>
    </p>
        ...
        <thead>
            <tr valign="top">
                <th scope="row" class="wps_wpr_head_titledesc">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Date & Time', 'points-and-rewards-for-woocommerce' ); ?></span>
                </th>
                <th scope="row" class="wps_wpr_head_titledesc">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Point Status', 'points-and-rewards-for-woocommerce' ); ?></span>
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( ' Check Number of Points Earned by Referring Others ', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
                ...
                <th class="wps-wpr-view-log-Activity">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Sign Up by', 'points-and-rewards-for-woocommerce' ); ?></span>
                </th>
            </tr>
        </thead>
        <?php
...
<div class="wps_wpr_slide_toggle">
    <p class="wps_wpr_view_log_notice wps_wpr_common_slider">
        <?php esc_html_e( 'Points earned by the purchase has been made by referrals', 'points-and-rewards-for-woocommerce' ); ?><a
            class="wps_wpr_open_toggle" href="javascript:;"></a></p>
    <table class="wps_wpr_common_table">
        <thead>
            <tr>
                ...
                <th class="wps-wpr-view-log-Activity">
                    <span
                        class="wps_wpr_nobr"><?php echo esc_html__( 'Product purchase by Referred User Points', 'points-and-rewards-for-woocommerce' ); ?></span>
                </th>
            </tr>
        </thead>
        <?php
...
<div class="wps_wpr_slide_toggle">
    <table class="wps_wpr_total_points">
        <tr>
            <td>
                <h4><?php esc_html_e( '포인트', 'points-and-rewards-for-woocommerce' ); ?></h4>
            </td>
            <td>
                <h4><?php echo esc_html( $total_points ); ?>원</h4>
            </td>
            <td></td>
        </tr>
    </table>
