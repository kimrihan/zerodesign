 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Points and Rewards for WooCommerce-v2
    ...
    <td colspan="4" class="plugin-update colspanchange">
        <div class="notice notice-error inline update-message notice-alt">
            <p class='wps-notice-title wps-notice-section'>
                <?php esc_html_e( 'The latest update includes some substantial changes across different areas of the plugin. Hence, if you are not a new user then', 'points-and-rewards-for-woocommerce' ); ?><strong><?php esc_html_e( ' please migrate your old data and settings from ', 'points-and-rewards-for-woocommerce' ); ?><a
                        style="text-decoration:none;"
                        href="<?php echo esc_url( admin_url( 'admin.php?page=wps-rwpr-setting' ) ); ?>"><?php esc_html_e( 'Dashboard', 'points-and-rewards-for-woocommerce' ); ?></strong></a><?php esc_html_e( ' page then Click On Start Import Button.', 'points-and-rewards-for-woocommerce' ); ?>
            </p>
        </div>
    </td>
</tr>
    ...
    <td colspan="4" class="plugin-update colspanchange">
        <div class="notice notice-error inline update-message notice-alt">
            ...
            <div class='wps-notice-content wps-notice-section'>
                <?php esc_html_e( 'You are Using the Old Version of Points and Rewards For WooCommerce Pro !!', 'points-and-rewards-for-woocommerce' ); ?><?php esc_html_e( ' Please Update it ', 'points-and-rewards-for-woocommerce' ); ?><a
                    style="text-decoration:none;"
                    href="<?php echo esc_url( admin_url( 'plugins.php' ) ); ?>"><strong><?php esc_html_e( ' Click Here', 'points-and-rewards-for-woocommerce' ); ?></strong></a><?php esc_html_e( ' to update to the latest ', 'points-and-rewards-for-woocommerce' ); ?>
            </div>
        </div>
    </td>
</tr>
...
<div class="notice notice-error is-dismissible">
    <p><?php esc_html_e( 'WooCommerce is not activated, Please activate WooCommerce first to activate Points and Rewards for WooCommerce.', 'points-and-rewards-for-woocommerce' ); ?>
    </p>
</div>
